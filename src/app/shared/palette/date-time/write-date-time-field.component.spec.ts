...
import { WriteDateTimeFieldComponent } from './write-date-time-field.component';
...
fdescribe('WriteDateTimeFieldComponent', () => {

  let fixture: ComponentFixture<WriteDateTimeFieldComponent>;
  let component: WriteDateTimeFieldComponent;
  let de: DebugElement;
  ...
  beforeEach(async(() => {
    ...
    fixture = TestBed.createComponent(WriteDateTimeFieldComponent);
